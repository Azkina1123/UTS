...
tabel_pesanan_penjual = '''CREATE TABLE tabel_pesanan_penjual (tanggal text, nomor_pesanan text, nama_masker text, jumlah integer, total integer, pembeli text, alamat text, status text)'''
